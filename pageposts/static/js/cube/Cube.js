...
function update() {
  ...
  if (rotatingLayer) {
    ...
    if (index >= scrambleMoveSet.length) {
      ...
      scrambled = true;
      index = 0;
      message = "Click on Cube to Solve or Change Speed";
    ...
    if (index >= solverMoveSet.length) {
      ...
      scrambled = false;
      index = 0;
      message = "Click on Cube to Scramble or Change Speed";
      document.getElementById("info").innerHTML = message;
    } else {
...
var changeState = function (event) {
  if (!scrambling && !solving) {
    if (scrambled) {
      solving = true;
      scrambling = false;
      message = "Solving Cube, Changing Speed Will Reset Cube";
      document.getElementById("info").innerHTML = message;
    } else {
      scrambling = true;
      solving = false;
      message = "Scrambling Cube, Changing Speed Will Reset Cube";
      document.getElementById("info").innerHTML = message;
    }
  }
}
...
function initCube() {
  ...
  var message = "Click on Cube to Scramble or Change Speed";
